...
try:
    # First try importing with the alias
    ...
    # Try importing the underscored version
    try:
        from src.utils.google_drive_manager import _drive_manager as drive_manager, sync_to_drive, sync_from_drive
